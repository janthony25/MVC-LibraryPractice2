...
namespace MVC_LibraryPractice2.Controllers
{
    public class BooksController : Controller
    {
        private readonly LibraryPractice2Context _context;

        public BooksController(LibraryPractice2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'LibraryPractice2Context.Book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LibraryPractice2Context.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
